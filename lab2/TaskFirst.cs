...
public class ElectronicProduct : Product
{
    ...
    public ElectronicProduct(int id, int amount, int price, string name, string manufacturer, DateTime purchaseDate, int warrantyPeriod)
    ...
    public override string ToString()
    {
        return base.ToString() + $", Name: {Name}, Manufacturer: {Manufacturer}, PurchaseDate: {PurchaseDate.ToShortDateString()}, WarrantyPeriod: {WarrantyPeriod} months";
    }
}